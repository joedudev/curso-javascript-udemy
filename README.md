# 🚀 Modern JavaScript: Mastering the Language

![Status: Learning](https://img.shields.io/badge/Status-In--Progress-yellow?style=for-the-badge&logo=javascript)
![Start Date](https://img.shields.io/badge/Started-March%202%2C%202026-blue?style=for-the-badge)
![Main Goal](https://img.shields.io/badge/Goal-Full--Stack%20Developer-orange?style=for-the-badge)
![Commit Style](https://img.shields.io/badge/Maintained%20with-Conventional%20Commits-1552F0?style=for-the-badge&logo=git)

Welcome to my learning journey! This repository contains all the code, notes, and projects developed during the **Modern JavaScript** course. My ultimate goal is to evolve from my current role as an **Analyst** to a professional **Full-Stack JavaScript Developer**, working remotely for global impact.
...
- **Objective:** 🌎 Remote Full-Stack Developer
- **Stack Focus:** JavaScript (ES6+), Node.js, React, and AI-driven development.
- **Contact:** 🔗 [Visit my GitHub Profile for Social Links](https://github.com/joedudev)

---

## 📚 Course Information

- **Course:** [JavaScript Moderno: Guía para dominar el lenguaje](https://www.udemy.com/share/102C033@r3_hM51ImfXwqg4TQHYsASYfBcrQ6_pFLQysxmW3x5Br2me3aLNDpHMSIHMGEyvpng==/)
- **Instructor:** Fernando Herrera (DevTalles)
- **Platform:** Udemy 🎓
- **My Student Profile:** [Eduardo Reyes @ Udemy](https://www.udemy.com/user/eduardo-reyes-2332/)

---

## ⚙️ Commit Strategy & Versioning

This repository follows the **Conventional Commits** specification to maintain a clean and readable history. Every commit is structured as:  
`<type>(<scope>): <emoji> <short description>`

### 🛠 Standard Types Used:

- **`feat`**: New lesson or lab exercise (e.g., `feat(blackjack): 🃏 add deck logic`).
- **`fix`**: Correcting a bug in an exercise.
- **`docs`**: Documentation changes (like this README).
- **`refactor`**: Code optimization without changing functionality.
- **`chore`**: Maintenance (Vite setup, dependencies, etc.).

### 🏷️ Tagging System:

I use **Semantic Versioning** tags to mark the completion of each module.

- `vX.0.0` for Major Labs/Projects.
- `v0.X.0` for Conceptual Modules.
...
| 13      | **Lab 3: CRUD App (No Frameworks)**        |   🏗️   | `v3.0.0-lab-crud`        |
| 14      | Advanced ESNext Features                   |   ⏳   | `v3.1.0-esnext-new`      |
| 15      | File Uploads & Final Polish                |   ⏳   | `v4.0.0-completed`       |
...
- **Environment:** Node.js, NPM, Vite
- **AI Assistants:** I leverage **GitHub Copilot** and **Google Gemini** to optimize my workflow as I follow the [Roadmap.sh Frontend Path](https://roadmap.sh/frontend).

---

## 📈 Goals for this Repository

1. **Semantic History:** Maintain 100% adherence to Conventional Commits.
2. **Clean Code:** Follow the "Uncle Bob" and Fernando Herrera standards.
3. **Documentation:** Use JSDoc to document functions and logic.
4. **Modern Workflow:** Transition from standard scripts to Vite-based development.
